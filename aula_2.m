...
%   x          -- posição posição final x do manipulador  
%   y          -- posição posição final y do manipulador
%   z          -- posição posição final z do manipulador
...
elseif x==0 && y==0 &&r<maxlength f=msgbox('Dá origem a uma singularidade', 'Error','error')
  ...
  w=1;
    ...
    %display dos angulos e da posição final para cada uma das soluções 
    f = figure;
