...
x(1)=str2num(answer2{1});  %-- coordenada x inicial da trajetória 
y(1)=str2num(answer2{2});  %-- coordenada y inicial da trajetória
z(1)=str2num(answer2{3});  %-- coordenada z inicial da trajetória
x(2)=str2num(answer2{4});  %-- coordenada x intermédia da trajetória
y(2)=str2num(answer2{5});  %-- coordenada y intermédia da trajetória
z(2)=str2num(answer2{6});  %-- coordenada z intermédia da trajetória
x(3)=str2num(answer2{7}); %-- coordenada x final da trajetória
y(3)=str2num(answer2{8}); %-- coordenada y final da trajetória
z(3)=str2num(answer2{9}); %-- coordenada z final da trajetória
tf(1)=str2num(answer2{10});%-- intervalo de tempo para robô percorrer a trajetória entre as coordenadas iniciais e intermédias
tf(2)=str2num(answer2{11});%-- intervalo de tempo para robô percorrer a trajetória entre as coordenadas intermédias e finais
